            ...
            {product.images.map((item, index) => (
              <CarouselItem key={index}>
                ...
                key={index}
                  ...
                  className={`object-cover transition-transform duration-300  ${showHover ? 'group-hover:scale-110' : 'group-hover:scale-100'}  h-[300px] rounded-t-md hover:cursor-pointer`}
                />
              </CarouselItem>
            ))}
          </CarouselContent>
